...
namespace Partie2
{
	public partial class Dijkstra : Form
	{
		...
		private void BInit2_Click(object sender, EventArgs e)
		{
		...
		private void BAEtoile_Click(object sender, EventArgs e)
		{
			numinitial = Convert.ToInt32(TBNoeuInit.Text);
			numfinal = Convert.ToInt32(TBNoeuFin.Text);
