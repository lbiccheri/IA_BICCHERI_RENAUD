namespace Partie2
{
	partial class FormUser
	{
		...
		private void InitializeComponent()
		{
			...
			this.LConsigne.Location = new System.Drawing.Point(400, 111);
			this.LConsigne.Name = "LConsigne";
			this.LConsigne.Size = new System.Drawing.Size(368, 17);
			this.LConsigne.TabIndex = 16;
			this.LConsigne.Text = "Remplissez les ouverts (O) et fermés (F) étape par étape";
			// 
			// DGVOuvFerm
			// 
			...
			this.label2.Location = new System.Drawing.Point(674, 184);
			...
			this.Controls.Add(this.LConsigne);
